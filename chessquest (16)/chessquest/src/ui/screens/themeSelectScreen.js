...
export function renderThemeSelect(root, { onSelect, onBack }) {
  ...
  screen.innerHTML = `
    ...
    <h1 class="cq-screen-title">Choose your world <span style="font-family:var(--font-mono);font-size:0.9rem;color:var(--brass);vertical-align:middle;">v16 · timers, pieces, coach, online themes</span></h1>
